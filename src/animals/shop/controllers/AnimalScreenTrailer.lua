...
AnimalScreenTrailer.initTargetItems = Utils.overwrittenFunction(AnimalScreenTrailer.initTargetItems, EL_AnimalScreenTrailer.initTargetItems)
...
AnimalScreenTrailer.getApplySourceConfirmationText = Utils.overwrittenFunction(AnimalScreenTrailer.getApplySourceConfirmationText, EL_AnimalScreenTrailer.getApplySourceConfirmationText)