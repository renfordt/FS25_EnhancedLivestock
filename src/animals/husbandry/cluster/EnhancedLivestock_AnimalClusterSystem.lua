EnhancedLivestock_AnimalClusterSystem = {}
local AnimalClusterSystem_mt = Class(AnimalClusterSystem)

function EnhancedLivestock_AnimalClusterSystem.new(superFunc, isServer, owner, customMt)
...
AnimalClusterSystem.new = Utils.overwrittenFunction(AnimalClusterSystem.new, EnhancedLivestock_AnimalClusterSystem.new)

function EnhancedLivestock_AnimalClusterSystem:delete()
...
AnimalClusterSystem.delete = Utils.appendedFunction(AnimalClusterSystem.delete, EnhancedLivestock_AnimalClusterSystem.delete)

function EnhancedLivestock_AnimalClusterSystem:getNextAnimalId()
    self.currentAnimalId = self.currentAnimalId + 1
    return self.currentAnimalId
end

AnimalClusterSystem.getNextAnimalId = EnhancedLivestock_AnimalClusterSystem.getNextAnimalId

function EnhancedLivestock_AnimalClusterSystem:getAnimals()
...
AnimalClusterSystem.getClusters = Utils.overwrittenFunction(AnimalClusterSystem.getClusters, EnhancedLivestock_AnimalClusterSystem.getClusters)

function EnhancedLivestock_AnimalClusterSystem:getCluster(superFunc, index)
