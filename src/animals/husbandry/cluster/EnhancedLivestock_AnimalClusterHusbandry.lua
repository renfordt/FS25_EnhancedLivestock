...
function EnhancedLivestock_AnimalClusterHusbandry:updateVisuals(superFunc, removeAll)
    ...
    if EnhancedLivestock_AnimalClusterHusbandry.MAX_HUSBANDRIES <= 0 or self.visualAnimalCount == EnhancedLivestock_AnimalClusterHusbandry.MAX_HUSBANDRIES then return end
    ...
    for _, animal in pairs(animals) do
        ...
        if self.visualAnimalCount >= EnhancedLivestock_AnimalClusterHusbandry.MAX_HUSBANDRIES or i > #self.husbandryIds or animal.isDead or animal.numAnimals <= 0 or animal.uniqueId == "1-1" or animal.uniqueId == "0-0" or (animal.id ~= nil and animal.idFull ~= nil and animal.id ~= "0-0" and animal.visualAnimalIndex == nil) then continue end
        ...
        if self.visualAnimalCount > EnhancedLivestock_AnimalClusterHusbandry.MAX_HUSBANDRIES then break end
