EnhancedLivestock_FarmStats = {}

function EnhancedLivestock_FarmStats:loadFromXMLFile(xmlFile, rootKey)
...
FarmStats.getNextAnimalId = EnhancedLivestock_FarmStats.getNextAnimalId