...
ELItemSystemMigration = {}

local OLD_MOD_NAME = "FS25_RealisticLivestock"
local NEW_MOD_NAME = "FS25_EnhancedLivestock"
...
function ELItemSystemMigration.loadHandToolsPrepend(handToolSystem, xmlFileOrFilename, asyncCallbackFunction, asyncCallbackObject, asyncCallbackArguments)
...
function ELItemSystemMigration.loadItemsFromXMLPrepend(itemSystem, xmlFile, key)
-- Only patch once per session
