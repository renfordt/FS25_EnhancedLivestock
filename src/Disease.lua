...
function Disease:showInfo(box)
	...
	if years == 0 then
		time = string.format("%d %s", months, months == 1 and g_i18n:getText("el_ui_month") or g_i18n:getText("el_ui_months"))
	elseif months == 0 then
		time = string.format("%d %s", years, years == 1 and g_i18n:getText("el_ui_year") or g_i18n:getText("el_ui_years"))
	else
		time = string.format("%d %s, %d %s", years, years == 1 and g_i18n:getText("el_ui_year") or g_i18n:getText("el_ui_years"), months, months == 1 and g_i18n:getText("el_ui_month") or g_i18n:getText("el_ui_months"))
	end
...
function Disease:getStatus()
	...
	if self.beingTreated then
		status = g_i18n:getText("el_ui_beingTreated")
	elseif self.cured then
		...
		if years == 0 then
			immuneTime = string.format("%d %s", months, months == 1 and g_i18n:getText("el_ui_month") or g_i18n:getText("el_ui_months"))
		elseif months == 0 then
			immuneTime = string.format("%d %s", years, years == 1 and g_i18n:getText("el_ui_year") or g_i18n:getText("el_ui_years"))
		else
			immuneTime = string.format("%d %s, %d %s", years, years == 1 and g_i18n:getText("el_ui_year") or g_i18n:getText("el_ui_years"), months, months == 1 and g_i18n:getText("el_ui_month") or g_i18n:getText("el_ui_months"))
		end

		status = string.format("%s (%s)", g_i18n:getText("el_ui_immune"), immuneTime)

	elseif self.isCarrier then

		status = g_i18n:getText("el_ui_carrier")

	else
		status = g_i18n:getText("el_ui_notTreated")
	end
