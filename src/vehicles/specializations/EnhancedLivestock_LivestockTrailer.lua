EnhancedLivestock_LivestockTrailer = {}

function EnhancedLivestock_LivestockTrailer:addAnimals(superFunc, animals)
...
--LivestockTrailer.dayChanged = Utils.overwrittenFunction(LivestockTrailer.dayChanged, EnhancedLivestock_LivestockTrailer.dayChanged)