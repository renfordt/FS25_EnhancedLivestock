EnhancedLivestock_VehicleSystem = {}

function EnhancedLivestock_VehicleSystem:save(_, _)
...
VehicleSystem.save = Utils.prependedFunction(VehicleSystem.save, EnhancedLivestock_VehicleSystem.save)