EnhancedLivestock_FSBaseMission = {}
...
FSBaseMission.onDayChanged = Utils.appendedFunction(FSBaseMission.onDayChanged, EnhancedLivestock_FSBaseMission.onDayChanged)