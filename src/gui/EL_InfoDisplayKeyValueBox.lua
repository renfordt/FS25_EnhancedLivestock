	...
	for _, line in ipairs(self.lines) do
		...
		if line.isActive then
			...
			if line.isWarning then
				...
				if value == "el_ui_genetics_extremelyLow" or value == "el_ui_genetics_extremelyBad" then
					setTextColor(1, 0, 0, 1)
				elseif value == "el_ui_genetics_veryLow" or value == "el_ui_genetics_veryBad" then
					setTextColor(1, 0.2, 0, 1)
				elseif value == "el_ui_genetics_low" or value == "el_ui_genetics_bad" then
					setTextColor(1, 0.52, 0, 1)
				elseif value == "el_ui_genetics_average" then
					setTextColor(1, 1, 0, 1)
				elseif value == "el_ui_genetics_high" or value == "el_ui_genetics_good" then
					setTextColor(0.52, 1, 0, 1)
				elseif value == "el_ui_genetics_veryHigh" or value == "el_ui_genetics_veryGood" then
