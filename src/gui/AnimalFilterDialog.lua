...
function AnimalFilterDialog:onOpen()
	...
	local anyText = g_i18n:getText("el_ui_any")
	local geneticsText = g_i18n:getText("el_ui_genetics") .. ": "
	...
	local filters = {

		{
			...
			["text"] = {
				["single"] = g_i18n:getText("el_ui_formatMonth"),
				["multiple"] = g_i18n:getText("el_ui_formatMonths")
			},
			["min"] = 0,
			["max"] = 1
		},
		...
		{
			["target"] = "weight",
			["name"] = g_i18n:getText("el_ui_weight"),
			["requiresMonitor"] = true,
			["template"] = "sliderTemplate",
			["text"] = {
				["single"] = "%skg",
		...
		{
			["target"] = "isPregnant",
			["name"] = g_i18n:getText("el_ui_pregnancy"),
			["template"] = "binaryOptionTemplate",
			["text"] = {
				{
					["text"] = g_i18n:getText("el_ui_notPregnant"),
					["value"] = false
				},
				{
					["text"] = anyText,
		...
		{
			["target"] = "gender",
			["name"] = g_i18n:getText("el_ui_gender"),
			["template"] = "binaryOptionTemplate",
			["text"] = {
				{
					["text"] = g_i18n:getText("el_ui_female"),
					["value"] = "female"
				},
				{
					["text"] = anyText,
				...
				{
					["text"] = g_i18n:getText("el_ui_male"),
					["value"] = "male"
				}
			},
			["default"] = 2
...

		{
			...
			["name"] = g_i18n:getText("el_disease"),
			["template"] = "binaryOptionTemplate",
			["text"] = {
				{
					["text"] = g_i18n:getText("el_ui_healthy"),
					["value"] = false
				},
				{
					["text"] = anyText,
				...
				{
					["text"] = g_i18n:getText("el_ui_hasDisease"),
					["value"] = true
				}
			},
			["default"] = 1
...

		{
			...
			["text"] = {
				{
					["text"] = g_i18n:getText("el_ui_doesntHaveName"),
					["value"] = false
				},
				{
					["text"] = anyText,
				...
				{
					["text"] = g_i18n:getText("el_ui_doesHaveName"),
					["value"] = true
				}
			},
			["default"] = 2
...

		{
			["isFunction"] = true,
			["target"] = "getSellPrice",
			["name"] = g_i18n:getText("el_ui_value"),
			["template"] = "sliderTemplate",
			["text"] = {
...

		{
			...
			["name"] = geneticsText .. g_i18n:getText("el_ui_metabolism"),
			["template"] = "sliderTemplate",
			["text"] = {
...

		{
			...
			["name"] = geneticsText .. g_i18n:getText("el_ui_health"),
			["template"] = "sliderTemplate",
			["text"] = {
				["formatFunction"] = AnimalFilterDialog.formatGenetics,
				["target"] = self,
...

		{
			...
			["name"] = geneticsText .. g_i18n:getText("el_ui_fertility"),
			["template"] = "sliderTemplate",
			["text"] = {
				["formatFunction"] = AnimalFilterDialog.formatGenetics,
				["target"] = self,
...

		{
			...
			["name"] = geneticsText .. g_i18n:getText("el_ui_meat"),
			["template"] = "sliderTemplate",
			["text"] = {
				["formatFunction"] = AnimalFilterDialog.formatGenetics,
				["target"] = self,
	...
	if self.animalTypeIndex == AnimalType.COW then
		...
		table.insert(filters, 6, {
			["target"] = "isLactating",
			["name"] = g_i18n:getText("el_ui_lactating"),
			["template"] = "binaryOptionTemplate",
			["text"] = {
				{
					["text"] = g_i18n:getText("el_ui_no"),
					["value"] = false
				},
				{
					["text"] = anyText,
		...
		for _, filter in pairs(filters) do
			...
			if filter.template == "sliderTemplate" then
				...
				elseif filter.isFunction then
					...
					if filter.name == "Value" and isBuyMode then
						value = value * 1.075
					end
...
function AnimalFilterDialog:formatGenetics(value)
	...
	return g_i18n:getText("el_ui_genetics_" .. text)
